...
public class NetworkManager extends CordovaPlugin {
  ...
  public void initialize(CordovaInterface cordova, CordovaWebView webView) {
    ...
    this.sockMan = new ConnectivityProxy(cordova);
    this.connectionCallbackContext = null;

    // We need to listen to connectivity events to update navigator.connection
    IntentFilter intentFilter = new IntentFilter();
    intentFilter.addAction(ConnectivityManager.CONNECTIVITY_ACTION);
    intentFilter.addAction(ConnectivityProxy.CONNECTIVITY_ACTION);
  ...
  public void onDestroy() {
    if (this.receiver != null) {
      try {
        ...
        Log.e(LOG_TAG,
            "Error unregistering network receiver: " + e.getMessage(), e);
      } finally {
        receiver = null;
      }
    }
      ...
      if (type.equals(WIFI)) {
        ...
        if (type.equals(GSM) || type.equals(GPRS) || type.equals(EDGE)) {
          return TYPE_2G;
            ...
            || type.equals(ONEXRTT) || type.equals(EHRPD) || type.equals(HSUPA)
            || type.equals(HSDPA) || type.equals(HSPA)) {
          return TYPE_3G;
